...
const OwnerProfilePage = () => {
  ...
  const [restaurant, setRestaurant] = useState({
    ...
    website: '', hours_of_operation: '', amenities: '',
    price_range: '', image: '',
  });
   ...
   useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        try {
          const photosRes = await api.get(`/restaurants/${res.data.id}/photos`);
  ...
  const handleGalleryUpload = async (e) => {
    ...
    try {
      const fd = new FormData();
      fd.append('file', file);
      const res = await api.post(`/restaurants/${restaurant.id}/photos`, fd, {
        headers: { 'Content-Type': 'multipart/form-data' },
      });
  ...
  const handleDeletePhoto = async (photoId) => {
    ...
    try {
      await api.delete(`/restaurants/${restaurant.id}/photos/${photoId}`);
              ...
              <Row>
                <Col md={8}>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control type="text" name="name" value={restaurant.name} onChange={handleChange} disabled={!isEditing} />
                  </Form.Group>
                </Col>
                <Col md={4}>
                  <Form.Group className="mb-3">
                    <Form.Label>Pricing Tier</Form.Label>
                    <Form.Select name="price_range" value={restaurant.price_range || ''} onChange={handleChange} disabled={!isEditing}>
                ...
                <Col md={6}>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Select name="cuisine" value={restaurant.cuisine || ''} onChange={handleChange} disabled={!isEditing}>
                ...
                <Col md={6}>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control type="text" name="phone" value={restaurant.phone || ''} onChange={handleChange} disabled={!isEditing} placeholder="(555) 000-0000" />
                  </Form.Group>
                </Col>
                <Col xs={12}>
                  <Form.Group className="mb-3">
                    <Form.Label>Description</Form.Label>
                    <Form.Control as="textarea" rows={3} name="description" value={restaurant.description || ''} onChange={handleChange} disabled={!isEditing} placeholder="Describe your restaurant..." />
                  </Form.Group>
                </Col>
              </Row>
              ...
              <Row>
                <Col md={6}>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control type="text" name="address" value={restaurant.address || ''} onChange={handleChange} disabled={!isEditing} placeholder="123 Main St" />
                  </Form.Group>
                </Col>
                <Col md={6}>
                  <Form.Group className="mb-3">
                    <Form.Label>City</Form.Label>
                    <Form.Control type="text" name="city" value={restaurant.city || ''} onChange={handleChange} disabled={!isEditing} placeholder="San Jose" />
                  </Form.Group>
                </Col>
                <Col md={4}>
                  <Form.Group className="mb-3">
                    <Form.Label>State</Form.Label>
                    <Form.Select name="state" value={restaurant.state || ''} onChange={handleChange} disabled={!isEditing}>
                ...
                <Col md={4}>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control type="text" name="zip_code" value={restaurant.zip_code || ''} onChange={handleChange} disabled={!isEditing} placeholder="95101" />
                  </Form.Group>
                </Col>
                <Col md={4}>
                  <Form.Group className="mb-3">
                    <Form.Label>Website</Form.Label>
                    <Form.Control type="text" name="website" value={restaurant.website || ''} onChange={handleChange} disabled={!isEditing} placeholder="https://..." />
                  </Form.Group>
                </Col>
              </Row>
              ...
              <Row>
                <Col md={6}>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control type="text" name="hours_of_operation" value={restaurant.hours_of_operation || ''} onChange={handleChange} disabled={!isEditing} placeholder="Mon-Sun 9AM-10PM" />
                  </Form.Group>
                </Col>
                <Col md={6}>
                  <Form.Group className="mb-3">
                    <Form.Label>Amenities</Form.Label>
                    <Form.Control type="text" name="amenities" value={restaurant.amenities || ''} onChange={handleChange} disabled={!isEditing} placeholder="WiFi, Outdoor Seating, Parking..." />
                  </Form.Group>
                </Col>
              </Row>
          ...
          <Card className="shadow-sm border-0">
            <Card.Body className="p-4">
              <div className="d-flex justify-content-between align-items-center border-bottom pb-2 mb-4">
                <div>
                  <h5 className="fw-bold mb-0">Restaurant Photos</h5>
                  <small className="text-muted">Upload photos to showcase your restaurant to customers</small>
                </div>
                <Button
                  variant="primary"
              ...
              {photos.length === 0 ? (
                <div className="text-center py-5 text-muted">
                  <FaCamera size={40} className="mb-3 opacity-25" />
                  <p className="mb-0">No photos yet. Click "Add Photo" to upload your first one.</p>
                </div>
              ) : (
                    ...
                    <Col key={photo.id}>
                      <div className="position-relative rounded overflow-hidden" style={{ height: '150px' }}>
                        ...
                        <Button
                          ...
                          style={{ width: '26px', height: '26px', fontSize: '16px' }}
